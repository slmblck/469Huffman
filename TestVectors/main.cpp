...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    myFile << " Here are the stats: " << endl;

    //cout << "Input bits before encryption: " << inLength << endl;
    myFile << "Input bits before encryption " << inLength << endl;
    
    //cout << "Input bits after encryption: " << inEncrypted << endl;
	myFile << "Input bits after encryption: " << inEncrypted << endl;    

    //cout << "Output bits before encryption: " << outLength << endl;
	myFile << "Output bits before encryption " << outLength << endl;    

    //cout << "Output bits after encryption: " << outEncrypted << endl;
	myFile << "Output bits after encryption: " << outEncrypted << endl;
...
//calculate percentages
	...
	inputPercentage = ((float)inEncrypted / (float)inLength) * 100.00;
	
	outputPercentage = ((float)outEncrypted / (float)outLength) * 100.00;

	myFile << "Percent of Original Input file size :  "  << inputPercentage << endl;

	myFile << "Percent of Original Ouput file size :  " << outputPercentage << endl << endl;
